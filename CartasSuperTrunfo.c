...
int main() {
    ...
    Cidade cartas[] = {
        ...
        {1139.047, 794.571, 72.946774, 7, "Campinas B01"},
        {11895.578, 1.521, 2719.751231, 18, "São Paulo B02"},
        {423.323, 1.378069, 34.555723, 7, "Piracicaba B03"},
        {728.615, 64.935, 76.311813, 6, "Osasco B04"},
        {460.434, 34.082, 20.059522, 6, "Porto Velho C01"},
        {86.887, 3.792, 32.313, 2, "Cacoal C02"},
        {108.528, 11.699, 2.000000, 3, "Vilhena C03"},
        {39.387, 24.855724, 740.159, 5, "Guajará Mirim C04"},
        {2417.678, 693.442, 62.954487, 11, "Salvador D01"},
        {237.821, 6.721, 5.181529, 5, "Juazeiro D02"},
        {178.649, 1.588555, 5.163622, 7, "Ilheus D03"},
        {300.372, 785421, 33.971705, 3, "Camaçari D04"},
        {754954, 4.115206, 43.129284, 5, "Uberlândia E01"},
        {411859, 343884, 33.132919131, 3, "Betim E02"},
        {621865, 195045, 36.479764, 5, "Contagem E03"},
        {227731, 164884, 17.609176, 4, "Ipatinga E04"},
        {203023, 2068474, 4.774446, 5, "Sobral F01"},
        {286120, 258788, 5.110056, 2, "Zuazero do Norte F02"},
        {2428.678, 312353, 73.436128, 6, "Fortaleza F03"},
        {131123, 1.614682, 1.190000000, 4, "Itapipoca F04"},
        {481749, 133757, 46.553203, 9, "Niterói G01"},
        {68088, 1.300767, 3.122611, 3, "Valença G02"},
